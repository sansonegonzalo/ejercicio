__EJERCICIO 1.__ :ballot_box_with_check:
```
Escribir un programa en React.js que recorra un arreglo y genere un histogramaen base a los 
números de este. El arreglo se llama myArray y contiene 10 elementos que corresponden a números
enteros del 1 al 5.
...
__EJERCICIO 2.__ :ballot_box_with_check:
```
